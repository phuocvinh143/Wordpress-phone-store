...
<div class="th-option-area">
        ...
        <div class="th-option-bottom-hdr">
            <a class="tablinks active" onclick="openTab(event, 'Welcome')"><?php _e('Welcome','big-store');?></a>
            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Import Demo Content','big-store');?> </a>
            <a class="tablinks" onclick="openTab(event, 'Recommanded-Plugin')"><?php _e('Recommanded Plugin','big-store');?> </a>
            <a class="tablinks" onclick="openTab(event, 'Free-Vs-Pro')"><?php _e('Free Vs Pro','big-store');?></a>
            <a class="tablinks" onclick="openTab(event, 'Help')"><?php _e('Help','big-store');?></a>
