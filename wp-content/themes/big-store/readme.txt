...
* New product category search disable.
* Below footer 2 column and 3 column option disable.
* New product search feature added.
...
= 1.5.7 =
* Theme Option panel links changed.
= 1.5.6 =
* Product Blur Image Issue Resolved.
...
= 1.4.9=
* Theme option panel useful plugin tab added.
* Checked with WordPress 5.7.

= 1.4.8 =
* WPC Smart Wishlist and WPC Smart Compare icons added.

= 1.4.7 =
* Category List Issue Fixed.
* Menu Style Fixed.
...
= 1.4.5 =
* License Issue Fixed.
* Content Anchor link underline Issue Fixed.
* Package Issue Fixed.
